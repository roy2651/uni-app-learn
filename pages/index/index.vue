<template>
	<view class="u-p-b-20">
		...
		<!-- tabs -->
		<view class="u-text-center u-m-t-20"><u-tabs :gutter="20" :item-width="160" :bar-height="12" :list="sortList" :current="sortCurrent" @change="sortChange"></u-tabs></view>
		<u-row gutter="16" class="u-skeleton">
			<u-col span="6" v-for="(goods, index) in goodsList.length ? goodsList : 4" :key="index"><goods-card :goods="goods"></goods-card></u-col>
			<u-col span="12"><u-loadmore :status="isShowLoading" icon-color="#2979ff" color="#2979ff" /></u-col>
		</u-row>
		<!-- 返回顶部 -->
