	...
	<view class="wrap u-rela">
		<template v-if="Object.keys(goods).length">
			...
			<view class="goods-show ">
				<!-- 图片展示 -->
				<view class="u-text-center"><image mode="heightFix" :src="goods.cover_url"></image></view>
				<view class="u-p-20">
					<!-- 商品基本信息 -->
					...
					<view class="u-p-b-80">
						...
						<template v-if="tabsCurrent == 2">
							<u-row gutter="16">
								<u-col span="6" v-for="(goods, index) in likeGoods" :key="index"><goods-card :goods="goods"></goods-card></u-col>
							</u-row>
						</template>
					</view>
				</view>
			...
			<view class="navigation">
				...
				<view class="right"><u-button :disabled="goods.stock ? false : true" class="cart btn" @click="addCart" :ripple="true" type="primary">加入购物车</u-button></view>
			</view>
		</template>
		<template v-else>
			<view class="loading">
